...
class ParserModel(Model):
    ...
    def add_placeholders(self):
        ...
        """
        ### YOUR CODE HERE
        self.input_palceholder = tf.placeholder(tf.int32, (None, self.config.n_features))
    ...
    def create_feed_dict(self, inputs_batch, labels_batch=None, dropout=1):
        ...
        ### YOUR CODE HERE
        feed_dict = {
            self.input_palceholder: inputs_batch,
    ...
    def add_embedding(self):
        ...
        """
        ### YOUR CODE HERE
        embeddings = tf.nn.embedding_lookup(tf.constant(self.pretrained_embeddings), self.input_palceholder)
    ...
    def add_prediction_op(self):
        ...
        W = tf.Variable(xavier(shape=(self.config.n_features * self.config.embed_size, self.config.hidden_size)))
        U = tf.Variable(xavier(shape=(self.config.hidden_size, self.config.n_classes)))
